...
BossRoom::BossRoom(Player* PlayerPtr, int layer)
	:RoomBase(PlayerPtr, layer)
{
	...
	BossEnemy* BossEnemyPtr1 = new BossEnemy(m_Layer);
	m_EnemyVec.push_back(BossEnemyPtr1);
